...
describe('contour pieces', (): void => {
    it('a piece, given a step, will compute a three-element block, starting at zero, each next element up a step from the previous', (): void => {
    ...
    it('when flipped, will make everything negative', (): void => {
